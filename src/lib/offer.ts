export const offer = {
  ...
  timeline: {
    ...
    phases: [
      {
        ...
        description: {
          whatYouGet: "17 individual sessions (1on1) + 2 group sessions + 4 workshops + 3 assessments + personalized educational materials and exercises for every team member + documents and messages analysis + mentorship + e-mail and offline support (up to 3h per month) + 12-month wellbeing plan for every team member.",
      ...
      },
      {
        ...
        description: {
          whatYouGet: "15 individual sessions (1on1) + 3 group sessions + 3 workshops + Personalized educational materials and exercises for every team member, Document and message analysis",
      ...
      },
      {
        ...
        description: {
          whatYouGet: "6 individual sessions (1on1) + 6 group sessions + Personalized educational materials and exercises for every team member + Document and message analysis + Mentorship + e-mail and offline support (up to 3h per month)",
    ...
    totals: {
      ...
      excercises: "personalized materials and exercises ",
    },
