export const offer = {
  ...
  timeline: {
    ...
    phases: [
      {
        period: "Months 1–3",
        title: "Diagnostics & Initial Coaching",
        description: "Deep assessment of team dynamics and individual coaching sessions to identify root causes and establish trust.",
      },
      {
        period: "Months 4–6",
        title: "Workshops & Harmonization",
        description: "Intensive team workshops focused on communication, collaboration, and conflict resolution strategies.",
      },
      {
        period: "Months 7–12",
        title: "Ongoing Coaching & Accountability",
        description: "Sustained support with regular check-ins, performance tracking, and continuous improvement initiatives.",
      },
    ],
  },
  caseStudies: [
