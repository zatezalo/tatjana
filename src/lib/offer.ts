export const offer = {
  ...
  pain: {
    ...
    subheadline: "As a leader, you’re not just losing productivity - you’re losing sleep, money, and momentum.",
    bullets: [
      "You delegate work, but it comes back late, half-done, or not at all.",
      "You repeat your feedback in every meeting, yet nothing changes.",
      "You’re stuck putting out fires your team should have prevented.",
  ...
  dream: {
    ...
    bullets: [
      "Meetings are short, decisions are acted on, execution happens.",
      "You delegate once - it gets done.",
      "The team takes ownership, aligns quickly, and proposes practical ways to grow revenue.",
      "Your best people stay because they are trusted, challenged, and recognised.",
      "Projects are on schedule and done right.",
    ],
  ...
  timeline: {
    ...
    phases: [
      {
        ...
        description: {
          whatYouGet: "17 individual sessions (1on1), 2 group sessions, 4 workshops, 3 assessments, Personalized educational materials and exercises for every team member, Document and message analysis, Mentorship + e-mail and online support (up to 3h per month), 12-month Wellbeing plan for every team member - exclusive to Commit Plan.",
          howWeWork: "We establish a factual baseline of how the team works today, surface the real problems slowing delivery, and reset communication - grounded in mutual respect and clear expectations - roles are clear and delegation holds.",
      ...
      },
      {
        ...
        description: {
          whatYouGet: "15 1on1 sessions, 3 group sessions, 3 workshops, Personalized educational materials and exercises for every team member, Document and message analysis",
      ...
      },
      {
        ...
        description: {
          whatYouGet: "6 individual sessions (1on1), 6 group sessions, Personalized educational materials and exercises for every team member, Document and message analysis, Mentorship + e-mail and online support (up to 3h per month)",
    ...
    totals: {
      oneOnOne: "38 individual sessions",
  ...
  valueStack: {
    ...
    subheadline: "Base program includes 4 people (manager + 3 reports). More slots available for bigger teams.",
    items: [
      ...
      { name: "Mentorship + e-mail and online support (up to 3h per month)", value: "€7,200" },
    ],
    totalValue: "€30,950",
    investment: {
      upfront: "€12,000",
  ...
  finalCta: {
    ...
    subtitle: "Book your free consultation - let's discuss how we can help your team reach its full potential.",
  },
};
